	...
	<table class="table table-striped">
      <thead>
        <tr>
          ...
          <th class="col-md-2"><?php echo Yii::t('AdminModule.post', 'Date Published')?></th>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a target="_blank" href="<?php echo Yii::app()->createUrl('post/' . $post->slug)?>"><?php echo htmlspecialchars($post->title)?></a></td>
          <td><?php echo $post->getRelated('author')->nickname?></td>
          <td><?php echo $post->date_publish?></td>
          <td>
