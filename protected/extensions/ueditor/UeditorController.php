...
class UeditorController extends CExtController{
    ...
    public function init(){
        ...
        $default = array(
            'imagePathFormat'=>$webroot.'/uploads/image/{yyyy}/{mm}/{time}{rand:6}',
            'scrawlPathFormat'=>$webroot.'/uploads/image/{yyyy}/{mm}/{time}{rand:6}',
            'snapscreenPathFormat'=>$webroot.'/uploads/image/{yyyy}/{mm}/{time}{rand:6}',
            'catcherPathFormat'=>$webroot.'/uploads/image/{yyyy}/{mm}/{time}{rand:6}',
            'videoPathFormat'=>$webroot.'/uploads/video/{yyyy}/{mm}/{time}{rand:6}',
            'filePathFormat'=>$webroot.'/uploads/file/{yyyy}/{mm}/{rand:4}_{filename}',
            'imageManagerListPath'=>$webroot.'/uploads/image/',
            'fileManagerListPath'=>$webroot.'/uploads/file/',
        );
